<?php
/**
 * Migration: Assign modes_of_travel to Travel documents.
 * 
 * - Common documents (Reason for Travel, Travel Order, etc.) get ALL modes.
 * - Specific documents get only their relevant modes.
 * 
 * Run once: php database/migrate_travel_modes.php
 */
